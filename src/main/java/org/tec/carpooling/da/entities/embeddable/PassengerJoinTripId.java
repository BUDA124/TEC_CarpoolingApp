...
@Embeddable
public class PassengerJoinTripId implements Serializable {
    ...
    public PassengerJoinTripId() {}

    public PassengerJoinTripId(Long idUser, Long idTrip) {
        this.idUser = idUser;
        this.idTrip = idTrip;
    }
    ...
    public boolean equals(Object o) {
        ...
        PassengerJoinTripId that = (PassengerJoinTripId) o;
